...
class pythonProgramOptions:
    ...
    if (compas_logs_output_override is None):
        output = os.getcwd()
        output_container = "COMPAS_Output_MM20"                 # names the directory to be created and in which log files are created.  Default in COMPAS is "COMPAS_Output"
    else:
    ...
    grid_filename = 'MM20_grid.txt'                             # grid file name (e.g. 'mygrid.txt')
