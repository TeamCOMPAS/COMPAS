...
class MSSFR(object):
    ...
    def __init__(self, verbose=False,\
                 metallicityGrid=None, totalMassEvolvedPerZ=None, binInLogSpace=True,\
        ...
        self.totalMassEvolvedPerZ  = totalMassEvolvedPerZ
...
def __init__(self, verbose=False,\n
             ...
             metallicityLowerLimit=1e-10, metallicityUpperLimit=1.,\n
             logOH12sun=8.69,     solarMetallicity=0.0142, cosmo=None):
    ...
    #pass the astropy  FlatLambdaCDM()
    #at instance cosmo=instance or we use default
    ...
    if cosmo is not None:
        ...
        #Have not defined a cosmology jet use a default
        self.cosmology = FlatLambdaCDM(H0=70 * u.km / u.s / u.Mpc, Om0=0.3)
