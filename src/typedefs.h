...
// Wind accretion descriptions
enum class WIND_ACCRETION_PRESCRIPTION: int { NONE, BONDI1995, ABATE2013};
const COMPASUnorderedMap<WIND_ACCRETION_PRESCRIPTION, std::string> WIND_ACCRETION_PRESCRIPTION_LABEL = {
    { WIND_ACCRETION_PRESCRIPTION::NONE, "NONE"},
    { WIND_ACCRETION_PRESCRIPTION::BONDI1995, "BONDI1944"},
    { WIND_ACCRETION_PRESCRIPTION::ABATE2013, "ABATE2013"}
};

// Wind accretion descriptions
enum class WIND_VELOCITY_PRESCRIPTION: int { YUNGELSON1995, VOGEL1991, BETA_LAW};
const COMPASUnorderedMap<WIND_VELOCITY_PRESCRIPTION, std::string> WIND_VELOCITY_PRESCRIPTION_LABEL = {
    { WIND_VELOCITY_PRESCRIPTION::YUNGELSON1995, "YUNGELSON1995"},
    { WIND_VELOCITY_PRESCRIPTION::VOGEL1991, "VOGEL1991"},
    { WIND_VELOCITY_PRESCRIPTION::BETA_LAW, "BETA_LAW"}    
};
