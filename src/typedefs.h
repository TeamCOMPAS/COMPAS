...
enum class QCRIT_PRESCRIPTION: int { NONE, ZERO, CLAEYS, GE20, GE20_IC, HURLEY_HJELLMING_WEBBINK};
const COMPASUnorderedMap<QCRIT_PRESCRIPTION, std::string> QCRIT_PRESCRIPTION_LABEL = {
    { QCRIT_PRESCRIPTION::NONE,    "NONE" },    // DEPRECATED June 2024 - remove end 2024
