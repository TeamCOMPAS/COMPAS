...
enum class WIND_ACCRETION_PRESCRIPTION: int { NONE, YUNGELSON1995, HIRAI2021, VOGEL1991, BETA_LAW};
const COMPASUnorderedMap<WIND_ACCRETION_PRESCRIPTION, std::string> WIND_ACCRETION_PRESCRIPTION_LABEL = {
    ...
    { WIND_ACCRETION_PRESCRIPTION::YUNGELSON1995, "YUNGELSON1995"},
    { WIND_ACCRETION_PRESCRIPTION::HIRAI2021, "HIRAI2021"},
    { WIND_ACCRETION_PRESCRIPTION::VOGEL1991, "VOGEL1991"},
    { WIND_ACCRETION_PRESCRIPTION::BETA_LAW, "BETA_LAW"}    
};
