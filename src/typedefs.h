...
// millisecond pulsar birth magnetic field distributions, when formed through AIC.
enum class MSP_BIRTH_MAGNETIC_FIELD_DISTRIBUTION: int { FLATINLOG, UNIFORM, LOGNORMAL };
const COMPASUnorderedMap<MSP_BIRTH_MAGNETIC_FIELD_DISTRIBUTION, std::string> MSP_BIRTH_MAGNETIC_FIELD_DISTRIBUTION_LABEL = {
    { MSP_BIRTH_MAGNETIC_FIELD_DISTRIBUTION::FLATINLOG, "FLATINLOG" },
    { MSP_BIRTH_MAGNETIC_FIELD_DISTRIBUTION::UNIFORM,   "UNIFORM" },
    { MSP_BIRTH_MAGNETIC_FIELD_DISTRIBUTION::LOGNORMAL, "LOGNORMAL" }
};

// millisecond pulsar birth spin period distributions, when formed through AIC.
enum class MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION: int { UNIFORM, NORMAL, LOGNORMAL };
const COMPASUnorderedMap<MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION, std::string> MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_LABEL = {
    { MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION::UNIFORM,    "UNIFORM" },
    { MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION::NORMAL,     "NORMAL" },
    { MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION::LOGNORMAL,  "LOGNORMAL" }
};
...
enum class PULSAR_MAGNETIC_FIELD_DECAY_ACCRETION_MODEL: int { NONE, EXPONENTIAL, SHIBAZAKI };
const COMPASUnorderedMap<PULSAR_MAGNETIC_FIELD_DECAY_ACCRETION_MODEL, std::string> PULSAR_MAGNETIC_FIELD_DECAY_ACCRETION_MODEL_LABEL = {
    { PULSAR_MAGNETIC_FIELD_DECAY_ACCRETION_MODEL::NONE,        "NONE" },
    { PULSAR_MAGNETIC_FIELD_DECAY_ACCRETION_MODEL::EXPONENTIAL, "EXPONENTIAL" },
    { PULSAR_MAGNETIC_FIELD_DECAY_ACCRETION_MODEL::SHIBAZAKI,   "SHIBAZAKI" }
};
...
enum class PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION: int { UNIFORM, NORMAL, LOGNORMAL };
const COMPASUnorderedMap<PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION, std::string> PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION_LABEL = {
    ...
    { PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION::LOGNORMAL,  "LOGNORMAL" }
};
