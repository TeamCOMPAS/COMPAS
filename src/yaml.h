...
// The default COMPAS YAML template follows    
    namespace {
        std::vector<std::string> yamlTemplate {
            ...
            "",
            "    ### PULSAR PARAMETERS",
            "    --msp-birth-magnetic-field-distribution-min                     # [log10(B/G)]",
            "    --msp-birth-magnetic-field-distribution-max                     # [log10(B/G)]",
            "    --msp-birth-magnetic-field-distribution-mean                    # [log10(B/G)]",
            "    --msp-birth-magnetic-field-distribution-sigma                   # [log10(B/G)]",
            "    --msp-birth-spin-period-distribution-min                        # [ms]",
            "    --msp-birth-spin-period-distribution-max                        # [ms]",
            "    --msp-birth-spin-period-distribution-mean                       # [ms]",
            "    --msp-birth-spin-period-distribution-sigma                      # [ms]",
