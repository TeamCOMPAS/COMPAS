...
// The default COMPAS YAML template follows    
    namespace {
        std::vector<std::string> yamlTemplate {
            ...
            "    --system-detailed-output-age-thresholds                         # age thresholds for the system detailed output file",
            "    --system-detailed-output-time-thresholds                        # time thresholds for the system detailed output file",
