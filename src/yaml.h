...
// The default COMPAS YAML template follows    
    namespace {
        std::vector<std::string> yamlTemplate {
            ...
            "    --initial-mass-power",
            "    --initial-stellar-type                                          # initial stellar type (if non-MS) for SSE",
            ...
            "    --initial-stellar-type-1                                        # primary initial stellar type (if non-MS) for BSE",
            "    --initial-stellar-type-2                                        # secondary initial stellar type (if non-MS) for BSE",
            "    --mass-ratio",
            "    --mass-ratio-min",
            "    --mass-ratio-max",
