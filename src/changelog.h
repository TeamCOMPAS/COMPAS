...
// 03.07.06   VK - Nov 13, 2024     - Enhancement:
//                                      - Added m_MomentOfInertiaPrevAU member variable to class BaseStar.
//                                      - Tides behavior updated to adjust initial stellar spins, to account for any mass or radius changes since previous timestep while conserving angular momentum for each star.

const std::string VERSION_STRING = "03.07.06";
