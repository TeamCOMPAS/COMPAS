...
//                                      - Added realistic tides to binary evolution. Functionality enabled by setting the new option `--tides-prescription` to the value `KAPIL2024` (default is `NONE`)
...
//                                      - Equilibrium tides implementation follows Barker, 2020, Eqs. (20) to (27)
