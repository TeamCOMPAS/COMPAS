 ...
 *
 * double MS_gt_07::CalculateCriticalMassRatio(const bool p_AccretorIsDegenerate) 
 *
 ...
 */
double MS_gt_07::CalculateCriticalMassRatio(const bool p_AccretorIsDegenerate) const {
