...
#define STAR_PROPERTIES                              \
    ...
    PULSAR_SPIN_PERIOD,                              \
    PULSAR_MAGNETIC_RADIUS,                          \
    PULSAR_COROTATION_RADIUS,                        \
    PULSAR_PROPELLER_MODE,                           \
...
const COMPASUnorderedMap<STAR_PROPERTY, std::string> STAR_PROPERTY_LABEL = {
    ...
    { STAR_PROPERTY::PULSAR_MAGNETIC_RADIUS,                          "PULSAR_MAGNETIC_RADIUS" },
    { STAR_PROPERTY::PULSAR_COROTATION_RADIUS,                        "PULSAR_COROTATION_RADIUS" },
    { STAR_PROPERTY::PULSAR_PROPELLER_MODE,                           "PULSAR_PROPELLER_MODE" },
...
enum class PROGRAM_OPTION: int {
    ...
    MSP_MAGNETIC_FIELD_DISTRIBUTION,
    MSP_MAGNETIC_FIELD_DISTRIBUTION_MAX,
    MSP_MAGNETIC_FIELD_DISTRIBUTION_MIN,
    MSP_MAGNETIC_FIELD_DISTRIBUTION_MEAN,
    MSP_MAGNETIC_FIELD_DISTRIBUTION_SIGMA,

    MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION,
    MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_MAX,
    MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_MIN,
    MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_MEAN,
    MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_SIGMA,
    ...
    NS_ACCRETION_IN_CE,
    NS_ACCRETION_EFFICIENCY_PARAMETER,
    NS_EOS,
    ...
    PULSAR_MAGNETIC_FIELD_DISTRIBUTION_MEAN,
    PULSAR_MAGNETIC_FIELD_DISTRIBUTION_SIGMA,

    PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION,
    PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION_MAX,
    PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION_MIN,
    PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION_MEAN,
    PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION_SIGMA,

    PULSAR_MAGNETIC_FIELD_DECAY_ACCRETION_MODEL,
...
const COMPASUnorderedMap<PROGRAM_OPTION, std::string> PROGRAM_OPTION_LABEL = {
    ...
    { PROGRAM_OPTION::MSP_MAGNETIC_FIELD_DISTRIBUTION,                  "MSP_MAGNETIC_FIELD_DISTRIBUTION" },
    { PROGRAM_OPTION::MSP_MAGNETIC_FIELD_DISTRIBUTION_MAX,              "MSP_MAGNETIC_FIELD_DISTRIBUTION_MAX" },
    { PROGRAM_OPTION::MSP_MAGNETIC_FIELD_DISTRIBUTION_MIN,              "MSP_MAGNETIC_FIELD_DISTRIBUTION_MIN" },
    { PROGRAM_OPTION::MSP_MAGNETIC_FIELD_DISTRIBUTION_MEAN,             "MSP_MAGNETIC_FIELD_DISTRIBUTION_MEAN" },
    { PROGRAM_OPTION::MSP_MAGNETIC_FIELD_DISTRIBUTION_SIGMA,            "MSP_MAGNETIC_FIELD_DISTRIBUTION_SIGMA" },

    { PROGRAM_OPTION::MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION,               "MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION" },
    { PROGRAM_OPTION::MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_MAX,           "MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_MAX" },
    { PROGRAM_OPTION::MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_MIN,           "MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_MIN" },
    { PROGRAM_OPTION::MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_MEAN,          "MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_MEAN" },
    { PROGRAM_OPTION::MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_MIN,           "MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_SIGMA" },
    ...
    { PROGRAM_OPTION::NS_ACCRETION_EFFICIENCY_PARAMETER,                "NS_ACCRETION_EFFICIENCY_PARAMETER" },
    ...
    { PROGRAM_OPTION::PULSAR_MAGNETIC_FIELD_DISTRIBUTION_MEAN,          "PULSAR_MAGNETIC_FIELD_DISTRIBUTION_MEAN" },
    { PROGRAM_OPTION::PULSAR_MAGNETIC_FIELD_DISTRIBUTION_SIGMA,         "PULSAR_MAGNETIC_FIELD_DISTRIBUTION_SIGMA" },
    ...
    { PROGRAM_OPTION::PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION_MEAN,       "PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION_MEAN" },
    { PROGRAM_OPTION::PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION_MIN,        "PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION_SIGMA" },
    ...
    { PROGRAM_OPTION::PULSAR_MAGNETIC_FIELD_DECAY_ACCRETION_MODEL,      "PULSAR_MAGNETIC_FIELD_DECAY_ACCRETION_MODEL" },
...
const std::map<ANY_STAR_PROPERTY, PROPERTY_DETAILS> ANY_STAR_PROPERTY_DETAIL = {
    ...
    { ANY_STAR_PROPERTY::PULSAR_MAGNETIC_RADIUS,                            { TYPENAME::DOUBLE,           "Pulsar_Magnetic_Radius",          "cm",               24, 15}},
    { ANY_STAR_PROPERTY::PULSAR_COROTATION_RADIUS,                          { TYPENAME::DOUBLE,           "Pulsar_Corotation_Radius",        "cm",               24, 15}},
    { ANY_STAR_PROPERTY::PULSAR_PROPELLER_MODE,                             { TYPENAME::BOOL,             "Pulsar_Propeller_Mode",           "-",                 0, 0 }},
...
const std::map<PROGRAM_OPTION, PROPERTY_DETAILS> PROGRAM_OPTION_DETAIL = {
    ...
    { PROGRAM_OPTION::MSP_MAGNETIC_FIELD_DISTRIBUTION,                          { TYPENAME::INT,        "PO_MSP_Mag_Field_Dstrbtn",               "-",          4, 1 }},
    { PROGRAM_OPTION::MSP_MAGNETIC_FIELD_DISTRIBUTION_MAX,                      { TYPENAME::DOUBLE,     "PO_MSP_Mag_Field_Dstrbtn_Max",           "Gauss",     24, 15}},
    { PROGRAM_OPTION::MSP_MAGNETIC_FIELD_DISTRIBUTION_MIN,                      { TYPENAME::DOUBLE,     "PO_MSP_Mag_Field_Dstrbtn_Min",           "Gauss",     24, 15}},
    { PROGRAM_OPTION::MSP_MAGNETIC_FIELD_DISTRIBUTION_MEAN,                     { TYPENAME::DOUBLE,     "PO_MSP_Mag_Field_Dstrbtn_Mean",          "Gauss",     24, 15}},
    { PROGRAM_OPTION::MSP_MAGNETIC_FIELD_DISTRIBUTION_SIGMA,                    { TYPENAME::DOUBLE,     "PO_MSP_Mag_Field_Dstrbtn_Sigma",         "Gauss",     24, 15}},

    { PROGRAM_OPTION::MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION,                       { TYPENAME::INT,        "PO_MSP_Spin_Period_Dstrbtn",             "-",          4, 1 }},
    { PROGRAM_OPTION::MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_MAX,                   { TYPENAME::DOUBLE,     "PO_MSP_Spin_Period_Dstrbtn_Max",         "ms",        24, 15}},
    { PROGRAM_OPTION::MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_MIN,                   { TYPENAME::DOUBLE,     "PO_MSP_Spin_Period_Dstrbtn_Min",         "ms",        24, 15}},
    { PROGRAM_OPTION::MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_MEAN,                  { TYPENAME::DOUBLE,     "PO_MSP_Spin_Period_Dstrbtn_Mean",        "ms",        24, 15}},
    { PROGRAM_OPTION::MSP_BIRTH_SPIN_PERIOD_DISTRIBUTION_SIGMA,                 { TYPENAME::DOUBLE,     "PO_MSP_Spin_Period_Dstrbtn_Sigma",       "ms",        24, 15}},
    ...
    { PROGRAM_OPTION::NS_ACCRETION_EFFICIENCY_PARAMETER,                        { TYPENAME::DOUBLE,     "PO_NS_ACCRETION_EFFICIENCY_PARAMETER",      "-",         24, 15}}, 
    ...
    { PROGRAM_OPTION::PULSAR_MAGNETIC_FIELD_DISTRIBUTION_MAX,                   { TYPENAME::DOUBLE,     "PO_Pulsar_Mag_Field_Dstrbtn_Max",           "Gauss",     24, 15}},
    { PROGRAM_OPTION::PULSAR_MAGNETIC_FIELD_DISTRIBUTION_MIN,                   { TYPENAME::DOUBLE,     "PO_Pulsar_Mag_Field_Dstrbtn_Min",           "Gauss",     24, 15}},
    { PROGRAM_OPTION::PULSAR_MAGNETIC_FIELD_DISTRIBUTION_MEAN,                  { TYPENAME::DOUBLE,     "PO_Pulsar_Mag_Field_Dstrbtn_Mean",          "Gauss",     24, 15}},
    { PROGRAM_OPTION::PULSAR_MAGNETIC_FIELD_DISTRIBUTION_SIGMA,                 { TYPENAME::DOUBLE,     "PO_Pulsar_Mag_Field_Dstrbtn_Sigma",         "Gauss",     24, 15}},

    { PROGRAM_OPTION::PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION,                    { TYPENAME::INT,        "PO_Pulsar_Spin_Period_Dstrbtn",             "-",          4, 1 }},
    { PROGRAM_OPTION::PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION_MAX,                { TYPENAME::DOUBLE,     "PO_Pulsar_Spin_Period_Dstrbtn_Max",         "ms",        24, 15}},
    { PROGRAM_OPTION::PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION_MIN,                { TYPENAME::DOUBLE,     "PO_Pulsar_Spin_Period_Dstrbtn_Min",         "ms",        24, 15}},
    { PROGRAM_OPTION::PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION_MEAN,               { TYPENAME::DOUBLE,     "PO_Pulsar_Spin_Period_Dstrbtn_Mean",        "ms",        24, 15}},
    { PROGRAM_OPTION::PULSAR_BIRTH_SPIN_PERIOD_DISTRIBUTION_SIGMA,              { TYPENAME::DOUBLE,     "PO_Pulsar_Spin_Period_Dstrbtn_Sigma",       "ms",        24, 15}},
    ...
    { PROGRAM_OPTION::PULSAR_MAGNETIC_FIELD_DECAY_ACCRETION_MODEL,              { TYPENAME::INT,        "PO_Pulsar_Mag_Field_Decay_Acc_Model",       "-",          4, 1 }},
...
const ANY_PROPERTY_VECTOR BSE_DETAILED_OUTPUT_REC = {
    ...
    STAR_1_PROPERTY::PULSAR_MAGNETIC_RADIUS,
    STAR_2_PROPERTY::PULSAR_MAGNETIC_RADIUS,
    STAR_1_PROPERTY::PULSAR_COROTATION_RADIUS,
    STAR_2_PROPERTY::PULSAR_COROTATION_RADIUS,
    STAR_1_PROPERTY::PULSAR_PROPELLER_MODE, 
    STAR_2_PROPERTY::PULSAR_PROPELLER_MODE, 
...
const ANY_PROPERTY_VECTOR SSE_PULSAR_EVOLUTION_REC = {
    ...
    STAR_PROPERTY::PULSAR_MAGNETIC_RADIUS,
    STAR_PROPERTY::PULSAR_COROTATION_RADIUS,
    STAR_PROPERTY::PULSAR_PROPELLER_MODE, 
