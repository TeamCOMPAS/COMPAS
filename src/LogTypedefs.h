...
const COMPASUnorderedMap<STAR_PROPERTY, std::string> STAR_PROPERTY_LABEL = {
    ...
    { STAR_PROPERTY::PULSAR_BIRTH_MAGNETIC_FIELD,                     "PULSAR_BIRTH_MAGNETIC_FIELD" },
...
const std::map<ANY_STAR_PROPERTY, PROPERTY_DETAILS> ANY_STAR_PROPERTY_DETAIL = {
    ...
    { ANY_STAR_PROPERTY::PULSAR_BIRTH_MAGNETIC_FIELD,                       { TYPENAME::DOUBLE,           "Pulsar_Birth_Mag_Field",          "Tesla",            24, 15}},
...
const ANY_PROPERTY_VECTOR BSE_DETAILED_OUTPUT_REC = {
    ...
    BINARY_PROPERTY::MASS_TRANSFER_TRACKER_HISTORY,
    STAR_1_PROPERTY::PULSAR_BIRTH_MAGNETIC_FIELD,
    STAR_2_PROPERTY::PULSAR_BIRTH_MAGNETIC_FIELD,
