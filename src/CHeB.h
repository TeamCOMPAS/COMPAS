...
protected:
    ...
    ENVELOPE        DetermineEnvelopeType()                                      { return ENVELOPE::RADIATIVE; }                                                // Always RADIATIVE (JR: changed to RADIATIVE, per http://gitlab.sr.bham.ac.uk/COMPAS/COMPAS/issues/135 and Hurley et al., 2002)
