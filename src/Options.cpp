    ...
    try {
        ...
        */
        ...
        (
            ...
            ("Choose remnant mass prescription (options: [HURLEY2000, BELCZYNSKI2002, FRYER2012, MULLER2016, MULLERMANDEL, SCHNEIDER2020, SCHNEIDER2020ALT, FARMER2019], default = " + p_Options->m_RemnantMassPrescription.typeString + ")").c_str()
        )
        (
