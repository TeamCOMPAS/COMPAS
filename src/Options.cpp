...
void Options::InitialiseMemberVariables(void) {
    ...
    maxEvolutionTime                                                = 13700.0;                                                                          // Maximum evolution time in Myr
    ...
    pulsarMagneticFieldDecayTimescale                               = 1000.0;                                                                           // Timescale on which magnetic field decays (Myr)
    ...
    try {
        ...
        desc.add_options()
            ...
            */
		    ...
		    ("maximum-evolution-time",                                      po::value<double>(&maxEvolutionTime)->default_value(maxEvolutionTime),                                                                                      ("Maximum time to evolve binaries in Myr (default = " + std::to_string(maxEvolutionTime) + ")").c_str())
		    ...
		    ("pulsar-magnetic-field-decay-timescale",                       po::value<double>(&pulsarMagneticFieldDecayTimescale)->default_value(pulsarMagneticFieldDecayTimescale),                                                    ("Timescale on which magnetic field decays in Myr (default = " + std::to_string(pulsarMagneticFieldDecayTimescale) + ")").c_str())
		    ...
		    */
		    ...
		    ("remnant-mass-prescription",                                   po::value<string>(&remnantMassPrescriptionString)->default_value(remnantMassPrescriptionString),                                                            ("Choose remnant mass prescription (options: HURLEY2000, BELCZYNSKI2002, FRYER2012, MULLER2016, MULLERMANDEL, SCHNEIDER2020, SCHNEIDER2020ALT), default = " + remnantMassPrescriptionString + ")").c_str())
