...
#define SHOW_ERROR_0()
#define SHOW_ERROR_1(error)                         { ERRORS->ShowIt(ERROR_PREFIX, error, "", ObjectId(), ObjectType(), StellarType(), __PRETTY_FUNCTION__); throw static_cast<int>(error); }
#define SHOW_ERROR_2(error, qualifyingStr)          { ERRORS->ShowIt(ERROR_PREFIX, error, qualifyingStr, ObjectId(), ObjectType(), StellarType(), __PRETTY_FUNCTION__); throw static_cast<int>(error); }
#define SHOW_ERROR_3()
#define SHOW_ERROR_4()
#define SHOW_ERROR_5()
...
#define SHOW_ERROR_IF_2(cond, error)                { if (cond) { ERRORS->ShowIt(ERROR_PREFIX, error, "", ObjectId(), ObjectType(), StellarType(), __PRETTY_FUNCTION__); throw static_cast<int>(error); }}
#define SHOW_ERROR_IF_3(cond, error, qualifyingStr) { if (cond) { ERRORS->ShowIt(ERROR_PREFIX, error, qualifyingStr, ObjectId(), ObjectType(), StellarType(), __PRETTY_FUNCTION__); throw static_cast<int>(error); }}
...
#define SHOW_ERROR_STATIC_3(error, objectType, stellarType)                 { ERRORS->ShowIt(ERROR_PREFIX, error, "", -1l, objectType, stellarType, __PRETTY_FUNCTION__); throw static_cast<int>(error); }
#define SHOW_ERROR_STATIC_4(error, qualifyingStr, objectType, stellarType)  { ERRORS->ShowIt(ERROR_PREFIX, error, qualifyingStr, -1l, objectType, stellarType, __PRETTY_FUNCTION__); throw static_cast<int>(error); }
...
#define SHOW_ERROR_IF_STATIC_4(cond, error, objectType, stellarType)                { if (cond) { ERRORS->ShowIt(ERROR_PREFIX, error, "", -1l, objectType, stellarType, __PRETTY_FUNCTION__); throw static_cast<int>(error); }}
#define SHOW_ERROR_IF_STATIC_5(cond, error, qualifyingStr, objectType, stellarType) { if (cond) { ERRORS->ShowIt(ERROR_PREFIX, error, qualifyingStr, -1l, objectType, stellarType, __PRETTY_FUNCTION__); throw static_cast<int>(error); }}
