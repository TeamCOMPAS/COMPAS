...
#define STAR_PROPERTIES                              \
    ...
    SUPERNOVA_KICK_MAGNITUDE_MAGNITUDE_RANDOM_NUMBER, \
    SUPERNOVA_PHI,                                   \
    SUPERNOVA_THETA,                                 \
    TEMPERATURE,                                     \
...
const COMPASUnorderedMap<STAR_PROPERTY, std::string> STAR_PROPERTY_LABEL = {
    ...
    { STAR_PROPERTY::SUPERNOVA_KICK_MAGNITUDE_MAGNITUDE_RANDOM_NUMBER, "SUPERNOVA_KICK_MAGNITUDE_MAGNITUDE_RANDOM_NUMBER" },
...
const std::map<ANY_STAR_PROPERTY, PROPERTY_DETAILS> ANY_STAR_PROPERTY_DETAIL = {
    ...
    { ANY_STAR_PROPERTY::SUPERNOVA_KICK_MAGNITUDE_MAGNITUDE_RANDOM_NUMBER,   { TYPENAME::DOUBLE,         "SN_Kick_Magnitude_Random_Number", "-",     14, 6 }},
...
const ANY_PROPERTY_VECTOR BSE_SYSTEM_PARAMETERS_REC = {
    ...
    STAR_1_PROPERTY::SUPERNOVA_KICK_MAGNITUDE_MAGNITUDE_RANDOM_NUMBER,
    STAR_1_PROPERTY::SUPERNOVA_THETA,
    STAR_1_PROPERTY::SUPERNOVA_PHI,
    STAR_1_PROPERTY::MEAN_ANOMALY,
    STAR_2_PROPERTY::SUPERNOVA_KICK_MAGNITUDE_MAGNITUDE_RANDOM_NUMBER,
