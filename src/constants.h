...
constexpr double Q_CNO                                  = 9.9073E10;                                                // Energy released per unit mass by hydrogen fusion via the CNO cycle in Lsol Msol-1
...
// unique mass values, second entry is the vector containing 7-tuples of vectors for logR, and the six qCrits listed above (in order). 
...
// from Shikauchi et al. (2024), ArXiv link TBD
// from Table 2
