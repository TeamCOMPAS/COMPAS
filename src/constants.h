...
constexpr double CONVECTIVE_BOUNDARY_TEMPERATURE_BELCZYNSKI = 5.3703E3;                                             // Threshold temperature for the star to develop a convective envelope, in Kelvin (10^3.73 K, from Belczynski+, 2008)
