...
const std::map<PROGRAM_OPTION, PROPERTY_DETAILS> PROGRAM_OPTION_DETAIL = {
    ...
    { PROGRAM_OPTION::ECCENTRICITY,                                             { TYPENAME::DOUBLE,     "PO_ccentricity",                           "-",         24, 15}},
    ...
    { PROGRAM_OPTION::LBV_PRESCRIPTION,                                         { TYPENAME::INT,        "PO_LBV_Mass_Loss_Prscrptn",                 "-",          4, 1 }},
...
// Critial mass ratios for a grid of masses and radii. This is a subset of Tables A3 and A4 from Ge et al. 2024 (arXiv:2408.16350),
// provided by private request to Hongwei Ge. This is the most up to date version of these tables at the time of writing
// (replacing Ge et al. 2020, and Li et al. 2023). Table A3 corresponds to low metallicity Z=0.001, Table A4 is for Z=0.02.
// Both of these tables are represented below as two separate nested vectors, and we interpolate linearly in logM, logR, and logZ. 
//
...
//
// Low Z = 0.001 table
const std::tuple< std::vector<double>, std::vector< std::tuple<std::vector<double>, std::vector<double>, std::vector<double>, std::vector<double>, std::vector<double>>>> QCRIT_GE_LOW_Z = {
...
//
// High Z = 0.02 table
const std::tuple< std::vector<double>, std::vector< std::tuple<std::vector<double>, std::vector<double>, std::vector<double>, std::vector<double>, std::vector<double>>>> QCRIT_GE_HIGH_Z = {
