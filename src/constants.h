...
const ANY_PROPERTY_VECTOR BSE_DOUBLE_COMPACT_OBJECTS_REC = {
    ...
    STAR_1_PROPERTY::TOTAL_MASS_AT_COMPACT_OBJECT_FORMATION,  // floor: move later 
    STAR_1_PROPERTY::HE_CORE_MASS_AT_COMPACT_OBJECT_FORMATION, // floor
    STAR_1_PROPERTY::CO_CORE_MASS_AT_COMPACT_OBJECT_FORMATION, // floor
    STAR_1_PROPERTY::CORE_MASS_AT_COMPACT_OBJECT_FORMATION, // floor
    STAR_1_PROPERTY::MASS,
    STAR_1_PROPERTY::STELLAR_TYPE,
    STAR_2_PROPERTY::TOTAL_MASS_AT_COMPACT_OBJECT_FORMATION,   // floor
    STAR_2_PROPERTY::HE_CORE_MASS_AT_COMPACT_OBJECT_FORMATION,   // floor
    STAR_2_PROPERTY::CO_CORE_MASS_AT_COMPACT_OBJECT_FORMATION,   // floor
    STAR_2_PROPERTY::CORE_MASS_AT_COMPACT_OBJECT_FORMATION,    // floor
