...
// removed commented RLOF printing lines in constant.h (somehow that was lost in some out of sync git merges - my fault...)
...
// fixed typo in zeta-calculation-every-timestep option in Options.cpp - this option would never have worked correctly

// options - flag options (bool) now bool_switch with defaults values
//           all numerical options now print correct/used defaultvalue in help (instead of text value that has not bben updated when default values have changed)

// options - check default strings e.g 'as in hurley', or 'fully convective'

// options - change comments for bool_switch - "do not retain previous (default)..."  - check this
// options - fix defaults for bool_switch - use variables!
