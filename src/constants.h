...
enum class ERROR: int {
    ...
    MAX_TIMESTEP_RETRIES,                                           // maximum number of timestep reduction retries
    ...
    SSE_REVERT_STATE_FAILED,                                        // Revert state failed in SSE code
...
const COMPASUnorderedMap<ERROR, std::tuple<ERROR_SCOPE, std::string>> ERROR_CATALOG = {
    ...
    { ERROR::MAX_TIMESTEP_RETRIES,                                  { ERROR_SCOPE::ALWAYS,              "Maximum number of timestep reduction tries reached" }},
    ...
    { ERROR::SSE_REVERT_STATE_FAILED,                               { ERROR_SCOPE::ALWAYS,              "Revert state failed in SSE code" }},
