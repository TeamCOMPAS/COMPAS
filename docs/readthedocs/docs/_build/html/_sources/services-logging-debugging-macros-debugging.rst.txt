...
A set of macros similar to the :doc:`logging macros <services-logging-debugging-macros-logging>` is also provided
for debugging purposes. These macros are analogous to their logging counterparts.
