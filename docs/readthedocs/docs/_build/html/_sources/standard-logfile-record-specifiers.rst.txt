...
Default record specifiers for each of the standard log files are shown in :doc:`standard-logfile-default-record-specifications`. 
The standard log file record specifiers can be defined by the user at run-time (see :doc:`standard-logfile-record-specification`).
