...
.. toctree::
   ...
   standard-logfile-record-specification-stellar
   standard-logfile-record-specification-binary
   standard-logfile-record-specification-options
...
::
    ...
    <prop name>  ::= valid property name for specified property type (see definitions in constants.h)
...
A log file specification record is initially set to its default value (see :doc:`standard-logfile-default-record-specifications`). 
...
A full example log file record specifications file is shown in :doc:`standard-logfile-example-definitions-file`.
