...
COMPAS data set in ``HDF5`` file format. If not, see [COMPAS h5 files.](../../notebooks/H5/0_H5Overview.ipynb). 
...
`class COMPAS <../../../notebooks/cosmicIntegration/1_ClassCOMPAS.ipynb>`__).
