...
\stellarProperty{DOMINANT\_MASS\_LOSS\_RATE}{INT}{BaseStar::m\_DMLR}{Current dominant mass loss rate printed as one of\begin{itemize}
    ...
    \item[]{Nieuwenhuijzen and de Jager\tabto{3.5em}=\tabto{5em}1}
    \item[]{Kudritzki and Reimers\tabto{3.5em}=\tabto{5em}2}
    \item[]{Vassiliadis and Wood\tabto{3.5em}=\tabto{5em}3}
    \item[]{Wolf-Rayet-like (Hamann, Koesterke and de Koter)\tabto{3.5em}=\tabto{5em}4}
    \item[]{Vink\tabto{3.5em}=\tabto{5em}5}
    \item[]{Luminous Blue Variable\tabto{3.5em}=\tabto{5em}6}
\end{itemize}}{}
