...
\stellarProperty{KICK\_MAGNITUDE}{DOUBLE}{BaseStar::m\_SupernovaDetails.kickMagnitude}{Magnitude of natal kick magnitude received during a supernova~(km~s$^{\minus{1}}$). Calculated using the drawn kick magnitude.}{Applied\_Kick\_Magnitude}{}
...
\stellarProperty{SUPERNOVA\_KICK\_MAGNITUDE\_MAGNITUDE\_RANDOM\_NUMBER}{DOUBLE}{BaseStar::m\_SupernovaDetails.kickMagnitudeRandom}{Random number for drawing the supernova kick magnitude magnitude (if required). \\ Supplied by user in grid file, default = random number drawn from [0..1).}{SN\_Kick\_Magnitude\_Random\_Number}{}
