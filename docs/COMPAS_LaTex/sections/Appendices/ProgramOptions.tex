...
\programOption{cool-wind-mass-loss-multiplier}{}{Multiplicitive constant for wind mass loss of cool stars (default = 1) }
...
\programOption{overall-wind-mass-loss-multiplier}{}{Multiplicitive constant for overall wind mass loss (default = 1). Note that this multiplication factor is applied after the luminous-blue-variable-multiplier and the wolf-rayet-multiplier.}
