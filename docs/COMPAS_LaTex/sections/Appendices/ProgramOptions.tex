...
\programOption{cool-wind-mass-loss-multiplier}{}{Multiplicative constant for wind mass loss of cool stars, i.e. those with temperatures below the VINK_MASS_LOSS_MINIMUM_TEMP  (default 12500 K). Affects   \\ Only applicable when mass-loss-prescription is set to VINK.}{1.0}
