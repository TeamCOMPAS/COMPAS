...
\programOption{mass-ratio}{}{Mass ratio $\frac{m2}{m1}$ used to determine secondary mass if not specified via \textit{\texttt{-{}-}initial-mass-2}.}{Value is sampled if option not specified.}
