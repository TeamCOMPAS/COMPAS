...
class BinaryPopulation:
    """
    General DCO population class supporting BBH, BNS, BHNS.
    ...
    def __init__(
        ...
        include_bns: bool = False,
        include_bhns: bool = False,
        m1_min: float = M1_MIN,
        m1_max: float = M1_MAX,
        m2_min: float = M2_MIN,
        ...
        self.include_bbh = include_bbh
        self.include_bns = include_bns
        self.include_bhns = include_bhns
    ...
    def from_compas_h5(
        ...
        mask = cls._generate_mask(path, include_bbh, include_bns, include_bhns)
        ...
        return cls(
            ...
            include_bbh=include_bbh,
            include_bns=include_bns,
            include_bhns=include_bhns,
            m1_min=m1_min,
            m1_max=m1_max,
            m2_min=m2_min,
    ...
    def _generate_mask(
        ...
        t1, t2, hubble_flag, dco_seeds = _load_data(
            path,
            "BSE_Double_Compact_Objects",
        ...
        masks = []
        if include_bbh:
            masks.append((t1 == 14) & (t2 == 14))
        if include_bns:
            masks.append((t1 == 13) & (t2 == 13))
        if include_bhns:
            masks.append((t1 == 14) & (t2 == 13) | (t1 == 13) & (t2 == 14))
    ...
    def bootstrap_population(self) -> "BinaryPopulation":
        ...
        return BinaryPopulation(
            ...
            include_bbh=self.include_bbh,
            include_bns=self.include_bns,
            include_bhns=self.include_bhns,
            m1_min=self.m1_min,
            m1_max=self.m1_max,
            m2_min=self.m2_min,
...
# Helper I/O function remains unchanged
...
def generate_mock_population(
    ...
    n_dcos = n_systems // 2
    n_ce = n_systems * 2
    types = np.random.choice(["BBH","BNS","BHNS"], size=n_dcos,
