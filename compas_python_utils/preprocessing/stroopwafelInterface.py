...
def main():
    ...
    commandOptions.update(
        {'--logfile-delimiter': 'COMMA'})  # overriden if there is a runSubmit + compas ConfigDefault.yaml
    ...
    sw_object.adapt(
        n_dimensional_distribution_type=distributions.Gaussian)  # Adaptaion phase, tell stroopwafel what kind of distribution you would like to create instrumental distributions
