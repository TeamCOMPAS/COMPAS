...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'globals.rst']
...
latex_documents = [
    (master_doc, 'COMPAS.tex', 'COMPAS Documentation',
     'Jeff Riley', 'manual'),
]
...
man_pages = [
    (master_doc, 'compas', 'COMPAS Documentation',
     [author], 1)
]
