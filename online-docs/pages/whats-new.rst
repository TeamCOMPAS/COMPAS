...
* New safeguard protocals in NS::CalculateBirthSpinPeriod() and NS::CalculateBirthMagneticField() to check the inputs for birth distributions of pulsar spin period and magnetic field are valid. However, users are strongly encouraged to make sensible inputs. 
